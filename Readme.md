...
This Python project helps students plan their study time based on subject difficulty and available hours per day. It automatically calculates recommended hours for each subject and tracks daily progress.


## 🧠 Features
- Difficulty-based time allocation (easy / medium / hard)
- Weighted study hour calculation
- Automatic pending list generation
...
completed = input("Enter the subjects you have completed today (comma separated): ")
